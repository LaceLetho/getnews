...
- `POST /semantic-search` — 统一语义搜索，跨域检索 `content_items` 和 `raw_intelligence_items`，返回 `source_breakdown`（含 `news.matched_count`、`news.retained_count`、`intelligence.matched_count`、`intelligence.retained_count`）
